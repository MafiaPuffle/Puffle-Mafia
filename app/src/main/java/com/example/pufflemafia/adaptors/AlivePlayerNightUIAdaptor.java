...
public class AlivePlayerNightUIAdaptor extends RecyclerView.Adapter<AlivePlayerNightUIAdaptor.ViewHolder> {
    ...
    public AlivePlayerNightUIAdaptor(Vector<Player> dataSet){
